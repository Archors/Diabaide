...
export async function updateAPI() {
    ...
    store.commit("SET_VALUE_HISTORY_MEALS",await getLast(store.getters.history_meals));
    store.commit("SET_VALUE_TIMESTAMP_MEALS",await getTimestampCompleteDate(store.getters.history_meals));
